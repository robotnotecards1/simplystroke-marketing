...
const DESCRIPTION =
  "SimplyStroke is free on the App Store for iPhone and Apple Watch: a one-tap golf stroke counter and scorecard. No subscription, no ads, no account to start. Or play right now in your browser.";
