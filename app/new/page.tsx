  ...
  return (
    <main className="nh">
      <style>{`
        ...
        /* editorial headings; balance kills orphan/hanging words like "way" */
        ...
        .nh-eyebrow { display:inline-flex; align-items:center; gap:9px; color:var(--lime-text); font-size:13px; font-weight:700; letter-spacing:.14em; text-transform:uppercase; }
        ...
        .nh-stat .n { font-family:var(--font-display); font-size:clamp(38px,4.6vw,60px); color:#fff; line-height:.85; margin-top:14px; }
        ...
        /* subtle grass texture instead of a flat cream fill */
        .nh-sec.tex { position:relative; background:#FAF9F5; isolation:isolate; }
        .nh-sec.tex::before { content:""; position:absolute; inset:0; z-index:-1; background:url("${PH}/green.jpg") center/cover; opacity:.09; }
        .nh-sec.dark { background:linear-gradient(165deg,var(--green-deep),#123527); color:#fff; }
        .nh-sec.dark h2 { color:#fff; } .nh-sec.dark p { color:rgba(255,255,255,.85); }
        ...
        /* device frame keeps its rounding (it's a phone); the green fade is the effect */
        ...
        /* ---------- FULL-BLEED PHOTO DIVIDER (sharp, full width) ---------- */
        .nh-divider { position:relative; min-height:clamp(280px,36vw,440px); display:flex; align-items:center; background-size:cover;
          background-image:linear-gradient(90deg,rgba(12,28,20,.85),rgba(12,28,20,.12)); background-position:center 58%; }
        ...
        .nh-divider .q .disp { color:#fff; font-size:clamp(30px,3.8vw,52px); max-width:24ch; }
        .nh-divider .q p { color:rgba(255,255,255,.82); font-size:18px; max-width:48ch; margin-top:18px; font-weight:500; }

        /* ---------- SIMPLE GRID (sharp cells) ---------- */
        .nh-grid { display:grid; grid-template-columns:repeat(3,1fr); gap:1px; margin-top:52px; background:rgba(27,67,50,.14); border:1px solid rgba(27,67,50,.14); }
        .nh-cell { background:#FAF9F5; padding:clamp(26px,3vw,40px); }
        .nh-cell h3 { font-size:26px; color:var(--green-deep); }
        .nh-cell p { color:var(--gray-body); font-size:15px; margin-top:8px; }

        /* ---------- SPLIT (image/device + copy) ---------- */
        ...
        /* PHOTOS: sharp corners, green fade — never rounded */
        ...
        .nh-split.dark h2, .nh-sec.dark .nh-split-copy h2 { color:#fff; }
        .nh-split-copy p { color:var(--gray-dark); font-size:17px; font-weight:500; margin-top:20px; max-width:48ch; }
        .nh-sec.dark .nh-split-copy p { color:rgba(255,255,255,.85); }
        ...
        /* device columns (phone / watch) — device frames stay rounded */
        ...
        .nh-watchbody { width:clamp(200px,22vw,260px); aspect-ratio:200/246; padding:14px; background:linear-gradient(160deg,#2b2b2e,#111113); border-radius:58px; filter:var(--fade); margin-inline:auto; }
        .nh-watchbody video { width:100%; height:100%; object-fit:cover; border-radius:44px; display:block; }

        /* ---------- LEADERBOARD CARD (sharp) ---------- */
        .nh-lb { background:rgba(255,255,255,.06); border:1px solid rgba(255,255,255,.12); }
        ...
        .nh-lb-rank { font-family:var(--font-display); font-size:20px; color:var(--lime); width:20px; text-align:center; }
        ...
        @media (max-width:900px){
          ...
          .nh-hero-p{ margin-inline:auto; } .nh-cta{ justify-content:center; } .nh-eyebrow{ justify-content:center; }
      ...
      <header className="nh-hero">
        <div className="nh-wrap nh-hero-inner">
          <div>
            <span className="nh-eyebrow">Free core scoring · One tap per shot</span>
        ...
        <div className="nh-wrap">
          ...
          <div className="nh-steps">
            <div className="nh-step">
              <div className="nh-devframe"><img src={`${SC}/home.png`} alt="SimplyStroke home screen with start new round" width={270} height={540} /></div>
              <div className="num">1</div><h3>Start your round</h3><p>Get going in one tap.</p>
            </div>
            <div className="nh-step">
              <div className="nh-devframe"><img src={`${SC}/course.png`} alt="SimplyStroke course select screen" width={270} height={540} /></div>
              <div className="num">2</div><h3>Pick a course</h3><p>Or skip it and just count.</p>
            </div>
            <div className="nh-step">
              <div className="nh-devframe"><img src={`${SC}/round.png`} alt="SimplyStroke active round, tap the golf ball" width={270} height={540} /></div>
              <div className="num">3</div><h3>Tap the ball</h3><p>One tap per shot. Undo fixes a mis-tap.</p>
            </div>
            <div className="nh-step">
              <div className="nh-devframe"><img src={`${SC}/scorecard.png`} alt="SimplyStroke finished scorecard" width={270} height={540} /></div>
      ...
      {/* ===== APPLE WATCH (moved up) ===== */}
      <section className="nh-sec dark">
        <div className="nh-wrap nh-split">
          <div className="nh-devcol">
            <div className="nh-watchbody">
              <video src="/videos/watch-live-round.mp4" autoPlay loop muted playsInline preload="metadata" aria-label="SimplyStroke on Apple Watch, counting strokes" />
            </div>
          </div>
          <div className="nh-split-copy">
            ...
            <ul className="nh-list">
              <li>Full-face tap target, glove-friendly.</li>
              <li>A haptic tick confirms every stroke.</li>
              <li>Syncs straight to your iPhone card.</li>
            </ul>
            <div className="nh-cta">
      ...
      {/* ===== GROUP SCORING (real scorecard mockup) ===== */}
      <section className="nh-sec dark">
        <div className="nh-wrap nh-split">
          <div className="nh-split-copy">
          ...
          <div className="nh-devcol">
            <div className="nh-devphone">
              <img src={`${SC}/scorecard.png`} alt="SimplyStroke shared scorecard, every hole totalled" width={270} height={540} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="nh-sec tex">
        <div className="nh-wrap nh-split">
          ...
          <div className="nh-lb" style={{ background: "var(--green-deep)", color: "#fff", borderColor: "rgba(255,255,255,.12)" }} aria-hidden="true">
      ...
      <section className="nh-sec">
        <div className="nh-wrap nh-split rev">
          <div className="nh-media"><img src={`${PH}/66454.jpg`} alt="A golfer crouched reading a putt at dusk" /></div>
          <div className="nh-split-copy">
