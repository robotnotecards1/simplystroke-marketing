...
// Isolated homepage redesign preview. Noindexed — a review route, not a live
// page. All styling is namespaced .nh-* and scoped to this page via inline
// <style>, so nothing here touches the live site.
...
// --- inline golf line-icons (from the purchased icon library) + a few drawn ---
const I = {
  ...
  return (
    <main className="nh">
      <style>{`
        ...
        /* lead-ins are a real design element now — bigger, bolder */
      ...
      <header className="nh-hero">
        <div className="nh-wrap nh-hero-inner">
          <div>
            ...
            <TrackedCta event="web_app_click" ctaLocation="new_hero" href={APP_URL} className="nh-webcta">or play free in your browser →</TrackedCta>
          </div>
          <HeroDevices />
        </div>
      </header>
      ...
      <section className="nh-sec dark">
        <div className="nh-wrap nh-split">
          <div className="nh-split-copy">
            ...
            <div className="nh-cta"><TrackedCta event="web_app_click" ctaLocation="new_group" href={APP_URL} className="nh-btn">Start a group round →</TrackedCta></div>
          </div>
